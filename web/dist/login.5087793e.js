...
var sesion = sessionStorage.getItem('sesion-estatus');
var user = sessionStorage.getItem('rol-user');
var users = [{
  user: "superuser",
  password: "root"
}];
  ...
  if (sesion != 'activate') {
    _sweetalert.default.fire({
      ...
      preConfirm: function preConfirm() {
        var login = _sweetalert.default.getPopup().querySelector('#login').value;

        var password = _sweetalert.default.getPopup().querySelector('#password').value;

        if (!login || !password) {
          _sweetalert.default.showValidationMessage("Por favor ingrese las credenciales.");
        }
